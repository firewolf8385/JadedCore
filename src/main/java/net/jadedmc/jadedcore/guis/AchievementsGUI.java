...
public class AchievementsGUI extends CustomGUI {
    ...
    public AchievementsGUI(final JadedCorePlugin plugin, Player player) {
        ...
        Minigame[] games = new Minigame[]{Minigame.GENERAL, Minigame.CACTUS_RUSH,Minigame.DUELS,Minigame.ELYTRAPVP};
     ...
     */
    public AchievementsGUI(final JadedCorePlugin plugin, Player player, Minigame game, int page) {
